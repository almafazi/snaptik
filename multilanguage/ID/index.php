...
<link rel="canonical" href="<?php echo $protocol . $_SERVER['HTTP_HOST']; ?>/id/">
...
<li><a 
    <?php if ($menu == null) { ?>
        class="active"
    <?php } ?>
    href="<?php echo $protocol . $_SERVER['HTTP_HOST']; ?>">TikTok Video</a></li>
<li><a 
    <?php if ($menu == 'download-tiktok-mp3') { ?>
        class="active"
    <?php } ?>
    href="<?php echo $protocol . $_SERVER['HTTP_HOST']; ?>/download-tiktok-mp3/">MP3</a></li>
<li><a 
    <?php if ($menu == 'download-tiktok-slideshow') { ?>
        class="active"
    <?php } ?>
    href="<?php echo $protocol . $_SERVER['HTTP_HOST']; ?>/download-tiktok-slideshow/">Slideshow</a></li>
<li><a 
    <?php if ($menu == 'download-tiktok-story') { ?>
        class="active"
    <?php } ?>
    href="<?php echo $protocol . $_SERVER['HTTP_HOST']; ?>/download-tiktok-story/">Story</a></li>
</ul>
...
<input name="url" id="url" type="text" class="form-control" value placeholder="Paste TikTok link disini" required aria-label="Name" autocomplete="off" autocapitalize="none">
...
<script type="text/javascript">var url = '<?php echo $protocol . $_SERVER['HTTP_HOST']; ?>';</script>
